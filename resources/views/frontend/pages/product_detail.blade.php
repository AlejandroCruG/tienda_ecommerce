					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Detalle de la compra</a></li>
							</ul>
						</div>
					</div>
				</div>
											...
											<div class="product-buy">
												<form action="{{route('single-add-to-cart')}}" method="POST">
													...
													<div class="add-to-cart mt-4">
														<button type="submit" class="btn">Añadir por carrito</button>
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		...
																		<p>Su dirección email no será publicada. Complete los campos requeridos</p>
																	</div>
																	<h4>Su calificación <span class="text-danger">*</span></h4>
																...
																<p class="text-center p-5">
																	Necesita <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Ingresar</a> O <a style="color:blue" href="{{route('register.form')}}">Registrarse</a>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
										<a href="{{route('product-detail',$data->slug)}}">
                                            ...
                                            <span class="price-dec">{{$data->discount}} % Descuentos</span>
                                                                    {{-- <span class="out-of-stock">Hot</span> --}}
                                        </a>
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View" href="#"><i class=" ti-eye"></i><span>Quick Shop</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Añadir a la Wishlist</span></a>
                                                <a title="Compare" href="#"><i class="ti-bar-chart-alt"></i><span>Añadir para comparar</span></a>
                                            </div>

                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>By {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Comentario ({{$post->allComments->count()}})</a></span>
                                    </div>
                            ...
                            <p class="text-center p-5">
                                Usted necesita <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Ingresar</a> O <a style="color:blue" href="{{route('register.form')}}">Registrarse </a> para comentar.
                ...
                <div class="col-lg-4 col-12">
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget category">
                            <h3 class="title">Categorias Blog</h3>
                        ...
                        <div class="single-widget newsletter">
                            <h3 class="title">Periodico</h3>
                            <div class="letter-inner">
                                <h4>Suscribase para obtener <br> ultimas novedades.</h4>
                                <form action="{{route('subscribe')}}" method="POST">
                                    @csrf
                                    <div class="form-inner">
                                        <input type="email" name="email" placeholder="Enter your email">
                                        <button type="submit" class="btn mt-2">Confirmar</button>
                                    </div>
                                </form>
                            </div>
                        </div>

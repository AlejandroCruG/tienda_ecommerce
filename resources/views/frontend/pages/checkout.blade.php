                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-12">
                            <div class="checkout-form">
                                <h2>Realice su pago aqui</h2>
                                <p>Por favor registrese para pagar más rapido</p>
                                <!-- Form -->
                                <div class="row">
                        ...
                        <div class="col-lg-4 col-12">
                            <div class="order-details">
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <ul>
										    <li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Subtotal carrito<span>${{number_format(Helper::totalCartPrice(),2)}}</span></li>
                                            <li class="shipping">
                                                Costo de Entrega
                                ...
                                <div class="single-widget">
                                    ...
                                    <div class="content">
                                        <div class="checkbox">
                                            ...
                                            <form-group>
                                                <input name="payment_method"  type="radio" value="cod"> <label>Efectivo a la entrega</label><br>
            ...
            <div class="inner-top">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2 col-12">
                        ...
                        <div class="inner">
                            <h4>Periodico</h4>
                            <p> Suscribase y obtenga un <span>10%</span> de descuento por su primera compra</p>
                            <form action="mail/mail.php" method="get" target="_blank" class="newsletter-inner">
                                <input name="EMAIL" placeholder="Your email address" required="" type="email">
                                <button class="btn">Suscribase</button>
                            </form>
                        </div>

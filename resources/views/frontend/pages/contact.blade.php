				...
				<div class="col-12">
					<div class="bread-inner">
						<ul class="bread-list">
							...
							<li class="active"><a href="javascript:void(0);">Contactar</a></li>
						</ul>
					</div>
				</div>
			</div>
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>Escribenos un mensaje @auth @else<span style="font-size:12px;" class="text-danger">[Necesita registrarse primero]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="name" id="name" type="text" placeholder="Escriba su nombre">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Tu asunto<span>*</span></label>
												<input name="subject" type="text" id="subject" placeholder="Escriba su asunto">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Tu Email<span>*</span></label>
												<input name="email" type="email" id="email" placeholder="Escriba su dirección email">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Tu telefono<span>*</span></label>
												<input id="phone" name="phone" type="number" placeholder="Escriba su telefono">
											</div>
										</div>
										<div class="col-12">
											<div class="form-group message">
												<label>Tu mensaje<span>*</span></label>
												<textarea name="message" id="message" cols="30" rows="9" placeholder="Escriba su mensaje"></textarea>
											</div>
										</div>
										<div class="col-12">
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">Llamenos ahora:</h4>
									<ul>
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-success">Su mensaje su enviado exitosamente...</p>
			</div>
		  </div>
		</div>
	</div>
	...
	<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-warning">Hubo un error.</p>
			</div>
		  </div>
		</div>
	</div>

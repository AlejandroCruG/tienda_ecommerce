...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('category.update',$category->id)}}">
        ...
        <div class="form-group">
          <label for="summary" class="col-form-label">Descripción</label>
        ...
        <div class="form-group">
          <label for="is_parent">Es Padre</label><br>
      ...
      <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}}" id='parent_cat_div'>
          <label for="parent_id">Padre Categoria</label>
          <select name="parent_id" class="form-control">
              <option value="">--Selecciona cualquier categoria--</option>

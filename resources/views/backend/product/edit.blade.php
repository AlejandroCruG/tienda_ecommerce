      ...
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group {{(($product->child_cat_id)? '' : 'd-none')}}" id="child_cat_div">
          ...
          <select name="child_cat_id" id="child_cat_id" class="form-control">
              <option value="">--Seleccione cualquier sub categoria--</option>
        ...
        <div class="form-group">
          ...
          <input id="price" type="number" name="price" placeholder="Escriba el precio"  value="{{$product->price}}" class="form-control">
          @error('price')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Escriba el descuento"  value="{{$product->discount}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              <option value="">--Seleccione cualquier--</option>
              ...
              <option value="M"  @if( in_array( "M",$data ) ) selected @endif>Medio</option>
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="new" {{(($product->condition=='new')? 'selected':'')}}>Nueva</option>
              <option value="hot" {{(($product->condition=='hot')? 'selected':'')}}>Tendencia</option>
          </select>
        </div>
            ...
            if(cat_id !=null){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        var html_option="<option value=''>--Seleccione cualquiera--</option>";
                        if(response.status){
